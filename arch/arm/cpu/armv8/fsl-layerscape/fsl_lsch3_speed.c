...
void get_sys_info(struct sys_info *sys_info)
{
	...
	uint i, cluster;
#if defined(CONFIG_TARGET_LS1028ARDB) || defined(CONFIG_TARGET_LS1088ARDB) || defined(CONFIG_TARGET_LS1028ATSN)
	uint rcw_tmp;
#endif
...
#if defined(CONFIG_TARGET_LS1028ARDB) || defined(CONFIG_TARGET_LX2160ARDB) || defined(CONFIG_TARGET_LS1028ATSN)
