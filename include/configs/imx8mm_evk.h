...
#define CONFIG_SYS_DDR_SDRAM_SLAVE_COREX_ADDR(coreid) (CONFIG_SYS_DDR_SDRAM_SLAVE_ADDR + \
        (coreid - 1) * CONFIG_SYS_DDR_SDRAM_SLAVE_SIZE)
#define CONFIG_SYS_DDR_SDRAM_SLAVE_COREX_RAMTOP_ADDR(coreid) (CONFIG_SYS_DDR_SDRAM_SLAVE_ADDR + \
        (coreid - 1) * CONFIG_SYS_DDR_SDRAM_SLAVE_SIZE + CONFIG_SYS_MALLOC_LEN + CONFIG_SYS_STACK_RESERVE_LEN )

#define CONFIG_SYS_DDR_SDRAM_SHARE_RESERVE_BASE (CONFIG_SYS_DDR_SDRAM_SHARE_BASE + CONFIG_SYS_DDR_SDRAM_SHARE_SIZE)
